...
class _MovieDetailScreenState extends State<MovieDetailScreen> {
  ...
  String getBackdropUrl() {
    ...
    } else if (poster.contains('cloudinary.com')) {
  ...
  Widget build(BuildContext context) {
    final movie = widget.movie;
    final finalBackdrop = getBackdropUrl();
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      const Column(
                        ...
                        children: [
                          ...
                          Text("out of 10", style: TextStyle(color: Colors.grey, fontSize: 16)),
                        ],
                      ),
                    ],
                  ),
                  ...
                  Text(
                    movie.description.isEmpty ? "No synopsis available." : movie.description,
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        elevation: 8,
                        shadowColor: Colors.purple.withAlpha((0.4 * 255).round()),
                      ),
                          ...
                          : Row(
                              ...
                              children: [
                                Icon(isFavorite ? Icons.favorite_rounded : Icons.favorite_border_rounded,
                                    color: isFavorite ? Colors.purpleAccent : Colors.white, size: 30),
